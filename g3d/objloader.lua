  ...
  for line in love.filesystem.lines(path) do
    ...
    elseif firstWord == "f" then
      ...
      for i = 2, #words do
        ...
        local vert = {v and positions[v][1] or 0, v and positions[v][2] or 0, v and positions[v][3] or 0,
                      vt and uvs[vt][1] or 0, vt and uvs[vt][2] or 0, vn and normals[vn][1] or 0,
                      vn and normals[vn][2] or 0, vn and normals[vn][3] or 0}
